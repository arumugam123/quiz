...
function show_next_question(){
	...
	//var as=qn;
	//alert(as);
	//document.getElementById('answer_value'+as).innerHTML="Ans";
	// last qn
	lqn=qn;	
...
function save_answer(qn){
	...
	//alert(qn);
	var final_question=$("#qidd_"+qn).val();
	//alert(final_question);
								// signal 1
						...
						$.ajax({
							...
							success: function(data){
							 ...
							 data : "final_question="+final_question,
								url: base_url + "index.php/quiz/save_answer_attempt/",
							success: function(data)
							{
