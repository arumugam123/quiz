<html lang="en" style="width: 1349px;">
  <head>
	...
	?>
        ...
        <div class="container-fluid">
         ...
         <img src="<?php echo base_url();?>img/logo.png">
          ...
          <div id="navbar" class="navbar-collapse collapse" style="padding-top: 16px";>
            <ul class="nav navbar-nav navbar-right">
			  <li><a href="<?php echo base_url();?>index.php/login/reply">Home</a></li>
...
{
			?>
			 <li <?php if($this->uri->segment(1)=='dashboard'){ echo "class='active'"; } ?> ><a href="<?php echo site_url('dashboard1');?>"><?php echo $this->lang->line('dashboard');?></a></li>
...
?>				 <li><a href="<?php echo site_url('quiz');?>"><?php echo $this->lang->line('quiz');?> <?php echo $this->lang->line('list');?></a></li>
			  ...
			  <?php  
				if($logged_in['su']==1){
			?>
		<?php /* 	 <li><a href="<?php echo site_url('payment_gateway');?>"><?php echo $this->lang->line('payment_history');?></a></li> */ ?>
			  <?php 
			 	if($this->session->userdata('gid')==0)
		{?>
