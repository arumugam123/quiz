...
<br> 
 ...
 <div class="panel-head" style="    background: mediumslateblue;
    ...
    color: white;
    font-size: 15px;"> 
 <label style="margin-bottom:0px;">Add New Quiz Here</label>
...
{
?>
<option value="<?php echo $level['sno'];?>"><?php echo $level['Level_name'];?></option>
<?php
			...
			<div class="form-group">	 
					<label for="inputEmail" class="sr-only">Subject Code</label> 
					<input type="text"  name="subject_code"  class="form-control" placeholder="Subject code"  required autofocus>
			</div>
				<div class="form-group">	 
			...
			<div class="form-group">	 
					<label for="inputCompiler" >Show Compiler</label> <br>
					<input type="radio" name="show_compiler"    value="1" > <?php echo $this->lang->line('yes');?>&nbsp;&nbsp;&nbsp;
					<input type="radio" name="show_compiler"    value="0"  > <?php echo $this->lang->line('no');?>
			</div>
