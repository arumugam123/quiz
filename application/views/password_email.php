...
ini_set('display_errors',0);
 $enc_pass_sess=$this->session->userdata('enc_pass_sess');
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="width:150px;">
                                                              <img alt="Logo" title="" height="auto" src="<?php echo base_url(); ?>images1/AICL_Logo.png"
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;">
                                                      <div style="font-size:1px;white-space:nowrap;"> </div>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        <p>Hello <?php echo $this->session->userdata('enc_user'); ?>,</p>
														
														<p class="hero">Welcome to AICL !</p>
														
														<p class="">To activate your account please click the button below to verify your email address:</p>
                                                        
                                                        
                                                        <p>
                                                          <a href="<?php echo base_url();?>index.php/login/verifyotp/<?php echo $this->session->userdata('enc_pass_sess'); ?>" class="btn" mc:disable-tracking="" style="color: #fff">Activate my Account</a>
                                                        </p>
                                                      <!--  <p>If you don’t know why you got this email, please tell us straight away so we can
                                                        ...
                                                        <p class="mb-0"><b>AICL Training</b></p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                </tbody>
