...
$logged_in=$this->session->userdata('logged_in');
 ...
 <h3 style="color:black;margin-left:20px;">Test List</h3>
    <?php 
	if($logged_in['su']=='1'){
		?>
		<div class="row">
...
<div class="col-lg-4 col-sm-6 portfolio-item" >
          <div class="card h-100">
            ...
            <div class="card-body">
              <h4 class="card-title"  align="center" style="border-bottom: 3px #179bd7 solid;">
                <a href="#" style=""><?php echo substr(strip_tags($val['quiz_name']),0,50);?></a>
              </h4>
			  ...
			  <li><strong>Pass Percentage: </strong><?php echo $val['pass_percentage'];?></li>
...
echo rtrim($quiz_cat_list,",");
			  ...
			  </ul> <?php //echo $this->session->userdata('uid');
//echo $val['quid'];
  $this->load->model('quiz_model');
$saf=$this->quiz_model->check_quiz1($val['quid'],$this->session->userdata('uid')); 
...
if($saf==0){
?>
<a href="<?php echo site_url('quiz/quiz_detail/'.$val['quid']);?>" class="btn btn-success" style="margin-left:100px;"> <?php echo $this->lang->line('attempt');?> </a>

<?php 	
}
else{
	?>
	<a  class="btn btn-warning" style="margin-left:100px;"> <?php echo "Taken";?> </a>
	<?php
}
