...
?>
 ...
 <div id="q<?php echo $qk;?>" class="question_div">
		...
		<b> <?php echo $this->lang->line('question');?> <?php echo $qk+1;?>)</b><br/><br/>
		<?php if($question['description'] !=""){
			?>
			<p><b>Description:</b> <?php  echo $question['description'];?></p>
		<br/>
	 <?php	}
...
<form method="post" action="">
   ...
   <?php  /*     <li><a data-toggle="tab" href="#input1">Input</a></li> */ ?>
        <li class="start"><a data-toggle="tab" href="#result1">Output</a></li>
    </ul>
