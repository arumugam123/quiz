...
if(isset($message_display)){
	echo $message_display;
		...
		?>
		<form method="post"  style="color:white;"class="form-horizontal" action="<?php echo site_url('Dashboard/insert_newskill/');?>">
		...
		?>	
						...
						<div class="form-group">
							<label class="col-md-6 control-label" for="skillreq">Required Skill</label>  
							<div class="col-md-6">
								<!--<input id="email" name="email" type="text" placeholder="Email Address" class="form-control"/>!-->
								
								<input type="text" id="inputskills" name="skillreq" placeholder="Skill Required" class="form-control" style="color:#000 !important;"   autofocus>
								
								<span style="color:#000 !important;" >(Type with no Caps, no spaces.Use underscores for spaces )</span>
								<?php echo form_error('skillreq') ; ?>
							</div>
						</div>
