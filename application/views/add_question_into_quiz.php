...
<?php
 ...
 <td>
<a href="javascript:addquestion('<?php echo $quid;?>','<?php echo $val['qid'];?>','<?php echo $val['cid'];?>','<?php echo $val['skill_id'];?>','<?php echo $val['sub_skill_id'];?>');" class="btn btn-primary" id='q<?php echo $val['qid'];?>'>
<?php 
...
function addquestion(quid,qid,cid,skillid,subskillid)
{
	//alert(skillid);
	...
	$.ajax({
		 type: "POST",
		 data : formData,
			url: base_url + "index.php/quiz/add_qid/"+quid+'/'+qid+'/'+cid+'/'+skillid+'/'+subskillid,
