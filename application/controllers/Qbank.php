...
class Qbank extends CI_Controller {
	...
	public function new_question_1($nop='4')
	{
		...
		// fetching level list
		$data['level_list']=$this->qbank_model->level_list();
		$data['skill_list']=$this->qbank_model->skill_list();
		$data['skill_list_main']=$this->qbank_model->skill_list_main();
		$data['company_list']=$this->qbank_model->company_list();
		 $this->load->view('header',$data);
		...
		public function new_question_4($nop='4')
	{
		...
		// fetching level list
		$data['level_list']=$this->qbank_model->level_list();
			 $data['skill_jobs']=$this->user_model->select_skill_jobs();
		 $this->load->view('header',$data);
...
$this->qbank_model->import_question($allxlsdata);   
  ...
  redirect('qbank');
	...
	function viewstudent($qid){
   
        $data['her']=$this->qbank_model->ques_name($qid);

        $data['clg']=$this->qbank_model->clg_name();
        $this->load->view('header');
        $this->load->view('student_attempt',$data);
       
    }
   
    function keyword_search(){
       
     $rt=$this->input->post('keyval');
     $rwt=$this->input->post('val');
       
    $uu['dd']=$this->Qbank_model->filters($rt,$rwt);
    $this->load->view('filter_student',$uu);
	...
	//echo $skill_id;
		$data['skills_list']=$this->qbank_model->skill_list($catid);
//print_r($data['skills_list']);
$this->load->view('ajax_skills',$data);
	}
	...
	//echo $skill_id;
		$data['category_list']=$this->qbank_model->cat_list($skill_id);
//print_r($data['skills_list']);
$this->load->view('ajax_cat',$data);
	}
